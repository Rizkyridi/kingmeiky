...
export const CircularTestimonials = ({
  ...
  return (
    <div suppressHydrationWarning className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p
                className="text-sm sm:text-base md:text-lg mb-4 md:mb-8"
          ...
          <div className="flex gap-6 pt-12">
            <button
              suppressHydrationWarning
              className="w-11 h-11 rounded-full flex items-center justify-center cursor-pointer transition-colors border-none flex-shrink-0"
              onClick={handlePrev}
              style={{
